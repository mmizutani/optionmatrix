...
extern void process_arguments(int argc, char **argv, bool *debug);
...
extern void program_check_pricing_models(void);
extern void program_check_pricing_time(int modelnumber, int iterations);

extern void process_arguments_checks(int argc, char **argv, bool *debug);
