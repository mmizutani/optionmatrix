...
int main(int argc, char *argv[])
{
  ...
  GError *err = NULL;
  //gtk_builder_add_from_file(properties.GtkInfo.builder, "gtkoptionmatrix.glade", &err);
  ...
  //gtk_container_add( GTK_CONTAINER ( GTK_DIALOG(properties.GtkInfo.dialogProperties)->action_area ), okay );
  //gtk_container_add( GTK_CONTAINER ( GTK_DIALOG(properties.GtkInfo.dialogProperties)->action_area ), cancel );
