...
gboolean calculate_options(struct _properties *properties)
{
  ...
  {
    //option_algorithms[properties->modeltype].supportTime2des[0] = toupper(option_algorithms[properties->modeltype].supportTime2des[0]);
  ...
  {
    //option_algorithms[properties->modeltype].supportTime3des[0] = toupper(option_algorithms[properties->modeltype].supportTime3des[0]);
